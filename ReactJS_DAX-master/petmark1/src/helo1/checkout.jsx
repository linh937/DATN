...
<main id="content" className="page-section sp-inner-page checkout-area-padding space-db--20">
	<div className="container">
		<div className="row">
					...
					<div className="row row-40">
						<div className="col-12">
							...
							<div className="checkout-quick-box">
								<p><i className="far fa-sticky-note"></i>Returning customer? <a href="javascript:" className="slide-trigger" data-bs-target="#quick-login">Click
										here to login</a></p>
							</div>
									...
									<div className="quick-login-form">
										...
										<div className="form-group">
											<div className="d-flex align-items-center">
												<a href="#" className="btn btn-black">Login</a>
							...
							<div className="checkout-quick-box">
								<p><i className="far fa-sticky-note"></i>Have a coupon? <a href="javascript:" className="slide-trigger" data-bs-target="#quick-cupon">
							...
							<div className="checkout-slidedown-box" id="quick-cupon">
								<form action="https://htmldemo.net/petmark/petmark/">
									<div className="checkout_coupon">
											...
											<a href="#" className="btn btn-black">Apply coupon</a>
									</div>
								</form>
							</div>
